...
//----------------------------------------------------------
void PrintOutputRecords(Spec_t* spec, int num, PrintFunc_t printFunc,FILE *fp)
{
	int maxNum = num;
	...
	for (int i = 0; i < maxNum; ++i)
	{
		...
		printFunc((char*)spec->outputKeys + index.x, (char*)spec->outputVals + index.z, index.y, index.w,fp);
	}
}
